  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        {error && (
          <div className="error-message" style={{ color: "red", marginBottom: "15px", fontSize: "14px" }}>
            {error}
          </div>
        )}
        ...
        <div style={{ textAlign: "center", marginTop: "15px", marginBottom: "5px" }}>
          <button 
            ...
            style={{ background: "none", border: "none", color: "#0056d2", cursor: "pointer", fontWeight: "bold" }}
          >
            {isLogin ? "New to Coursera? Sign Up" : "Already have an account? Log In"}
          </button>
        </div>
